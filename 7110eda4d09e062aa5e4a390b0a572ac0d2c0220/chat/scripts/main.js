...
function signIn(user) {
  ...
  if (user == "ckh") {
    ...
    email = "selina@bobo.net";
  }
  else {
    alert("User selected is not valid.");
    return;
  }
  console.log("Loging into the account of " + user + " ...");
  var password = window.prompt("Please input your password: ", "");
  if (password == null) {
    return;
  }
...
function getProfilePicUrl() {
  return firebase.auth().currentUser.photoURL || '../Dog.png';
}
...
function authStateObserver(user) {
  if (user) { // User is signed in!
    ...
    //signInCKHButtonElement.setAttribute('hidden', 'true');
    ...
    //signInHMCButtonElement.removeAttribute('hidden');
    //signInCKHButtonElement.removeAttribute('hidden');
...
var signInCKHButtonElement = document.getElementById('sign-in-ckh');
var signInHMCButtonElement = document.getElementById('sign-in-hmc');
